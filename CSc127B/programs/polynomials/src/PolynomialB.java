/*-------------------------------------------------------------------
 ...
 Purpose: holds an linkedList of term objects
...
public class PolynomialB implements Quantity{
  private LinkedList<Term> a1 = null;

  
  //constructor: sets new objects value to zero
  public PolynomialB() {
	  this.a1 = new LinkedList<Term>();
  }
  ...
  public PolynomialB add(PolynomialB a) {
	PolynomialB added = new PolynomialB();
	added.a1 = a1;
  ...
  PolynomialB replicate() {
    PolynomialB rep = new PolynomialB();
    rep.a1 = a1;
    return rep;
  }
  ...
  PolynomialB negate() {
    PolynomialB negate = new PolynomialB();
    negate.a1 = a1;
    int a1Size = a1.size();
    for(int i = 0; i < a1Size; i++) {
  ...
  //exponentList method: this method takes all exponents from all the terms and puts it into a linked list
  LinkedList<Integer> exponentList() {
