...
public class jacobi {
	...
	public jacobi(String[] args) {
		...
		int seconds = (int) (difference / 1000000000);
		int microseconds = (int) (( difference - (seconds * 1000000000) ) / 1000);
		
		System.out.println("runtime: "+seconds+" seconds, "+microseconds+" microseconds");
		...
		try{
			...
			writer.println("runtime: "+seconds+" seconds, "+microseconds+" microseconds");
			for (i = 0; i < numThreads; i++) {
